...
class SaveRepoInteractor(private val repositoryLocal: RepoRepository,
                         private val repositoryRemote: RepoRepository) : InteractorFlowable<List<Long>, SaveRepoInteractor.Request>() {
