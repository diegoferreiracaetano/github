...
class NetworkStatusViewHolder(val binding: ItemNetworkStateBinding, val retryCallback: () -> Unit)
    ...
    companion object {
        fun create(parent: ViewGroup, retryCallback: () -> Unit): NetworkStatusViewHolder {
            ...
            val binding: ItemNetworkStateBinding = DataBindingUtil
                    .inflate(inflater, R.layout.item_network_state, parent, false)
