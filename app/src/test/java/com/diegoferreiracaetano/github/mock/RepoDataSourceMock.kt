...
class RepoDataSourceMock(val list: List<Repo>) : PageKeyedDataSource<Int, Repo>() {
    ...
    class RepoDataSourceFactory(val list: List<Repo>) : DataSource.Factory<Int, Repo>() {
        ...
        val source = MutableLiveData<RepoDataSourceMock>()

        override fun create(): DataSource<Int, Repo> {
            val dataSource = RepoDataSourceMock(list)
